res_en = {
  main: {
    ...
    pick_weapon_melee:
      "Pick at least 1 melee weapon per chosen hero! (career tied weapon)",
    pick_weapon_ranged:
      "Pick at least 1 ranged weapon per chosen hero! (career tied weapon)",
    credits_v2fandom:
      'Images source: <a href="https://vermintide2.fandom.com">https://vermintide2.fandom.com</a>',
  },
  characters: {
  ...
  careers: {
    ...
    [cls_str.SALTZ_WP]: "Warrior Priest of Sigmar",
    ...
    [cls_str.SIENNA_NCR]: "Necromancer",
  ...
  weapons_melee: {
    ...
    [wpnm_str.SALTZ_HMMR2H]: "Holy Great Hammer",
    [wpnm_str.SALTZ_HMMR1H]: "Skull-Splitter Hammer",
    [wpnm_str.SALTZ_HMMRDUAL]: "Paired Skull-Splitters",
    [wpnm_str.SALTZ_HMMRNSHLD]: "Skull-Splitter & Shield",
    [wpnm_str.SALTZ_HMMRNTOME]: "Skull Splitter & Blessed Tome",
    [wpnm_str.SALTZ_FLAILNSHLD]: "Flail and Shield",
    ...
    [wpnm_str.SIENNA_REAPER]: "Ensorcelled Reaper",
  ...
  weapons_ranged: {
    ...
    [wpnr_str.SIENNA_SOULSTLR]: "Soulstealer Staff",
  ...
  settings: {
    ...
    dlc: {
      ...
      [options_str.DLC_WP]: "Disable <b>Warrior Priest of Sigmar</b> DLC",
      [options_str.DLC_NCR]: "Disable <b>Necromancer</b> DLC",
    },
    roulette: {
    ...
    preset: {
      ...
      description:
        "You can save currently checked boxes to load them next time you open the page.",
      message_saved:
