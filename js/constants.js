...
const wpnm_str = {
  ...
  SIENNA_DAG: "sienna-dag-1234",
  SIENNA_SWRDFIRE: "sienna-swrdfire-1234",
  SIENNA_MACE2H: "sienna-mace2h-1234",
  SIENNA_SWRD: "sienna-swrd-1234",
  SIENNA_CRWBILL: "sienna-crwbill-1234",
  SIENNA_FLAIL: "sienna-flail-1234",
  SIENNA_REAPER: "sienna-reaper-1234",
...
const wpnr_str = {
  ...
  SIENNA_BEAM: "sienna-beam-1234",
  SIENNA_BOLT: "sienna-bolt-1234",
  SIENNA_CONF: "sienna-conf-1234",
  SIENNA_FIREBALL: "sienna-fireball-1234",
  SIENNA_FLAME: "sienna-flame-123",
  SIENNA_CRSC: "sienna-crsc-1234",
  SIENNA_SOULSTLR: "sienna-soulstlr-4",
...
const dlc_gk_wpn = [wpnm_str.KRUBER_BRETSWRD, wpnm_str.KRUBER_BRETSWRDNSHLD];

const dlc_oe_wpn = [wpnm_str.BARDIN_COGHMMR, wpnr_str.BARDIN_MWPSTL];
...
const dlc_st_wpn = [wpnr_str.KERI_BRJV, wpnr_str.KERI_DPWD];
...
const dlc_ncr_wpn = [wpnm_str.SIENNA_REAPER, wpnr_str.SIENNA_SOULSTLR];
...
const dlc_ncr_cls = cls_str.SIENNA_NCR;
